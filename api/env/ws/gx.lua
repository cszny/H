  ...
  do
    ...
    Utility["Gradient"] = Library:create("UIGradient", {
      ...
      Color = ColorSequence.new{
        ColorSequenceKeypoint.new(0, Color3.fromRGB(Settings.Themes[WindowConfig.Theme].background.R + 10, Settings.Themes[WindowConfig.Theme].background.G + 10, Settings.Themes[WindowConfig.Theme].background.B + 10)), 
        ColorSequenceKeypoint.new(1, Settings.Themes[WindowConfig.Theme].background),
      }
    })
  ...
  do
    if WindowConfig.Intro then
      ...
      Utility["Gradient2"] = Library:create("UIGradient", {
        ...
        Rotation = 45,
        Color = ColorSequence.new{
          ColorSequenceKeypoint.new(0, Color3.fromRGB(Settings.Themes[WindowConfig.Theme].background.R + 10, Settings.Themes[WindowConfig.Theme].background.G + 10, Settings.Themes[WindowConfig.Theme].background.B + 10)),  -- Bottom color
          ColorSequenceKeypoint.new(1, Settings.Themes[WindowConfig.Theme].background) -- Top color
        }
      })
