...
local Settings = {
  ...
  Properties = {
    MainSize = UDim2.new(0, 400, 0, 270),
    CenteredAnchor = Vector2.new(0.5, 0.5),
    CenteredPosition = UDim2.new(0.5, 0, 0.5, 0)
  },
...
function Function:DestroyUI()
  ...
  elseif CoreGui:FindFirstChild("hikariCheat") ~= nil and game.Lighting:FindFirstChild("Blur") ~= nil then
    CoreGui:FindFirstChild("hikariCheat"):Destroy()
    game.Lighting:FindFirstChild("Blur"):Destroy()
  elseif gethui():FindFirstChild("hikariCheat") ~= nil and game.Lighting:FindFirstChild("Blur") ~= nil then
    gethui():FindFirstChild("hikariCheat"):Destroy()
    game.Lighting:FindFirstChild("Blur"):Destroy()
  end
end
...
function Library:NewWindow(WindowConfig)
  ...
  do
    ...
    Utility["Main"] = Library:create("Frame", {
      Name = "hikariMain",
      BorderSizePixel = 0,
      AnchorPoint = Settings.Properties.CenteredAnchor,
      Position = Settings.Properties.CenteredPosition,
      Size = Settings.Properties.MainSize,
      Parent = Utility["GUI"],
    ...
    Utility["Minimize"].InputBegan:Connect(function(input)
      if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
        ...
        if Minimized then
          ...
          Function:Tween(Utility["Main"], {Size = Settings.Properties.MainSize})
        end
      end
    end)
  end
...
function Library:ShowError(ErrorConfig)
  ...
  Utility["FrameRadius"] = Library:create("UICorner", {
    CornerRadius = UDim.new(0, 10),
    Parent = Utility["ErrorFrame"]
  })
